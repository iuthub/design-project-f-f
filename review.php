...
<div id="page-wrapper">
    ...
    <section id="quiz" class="container-fluid">
        <div class="container-fluid">
            <br><br><br>
<?php
echo "<h1 style='color: #00a65a' align='center'> Review Test Question</h1>";
...
$sql=mysqli_query($cn,"select * from mst_useranswer where sess_id='" . session_id() ."'") or die(mysqli_error());
